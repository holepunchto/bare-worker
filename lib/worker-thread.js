...
Bare.argv.splice(1, Bare.argv.length, state.entry, ...state.argv.map((arg) => String(arg)))

// Expose the other end of the parent port's IPC stream as the conventional
// `Bare.IPC` binary duplex stream.
Bare.IPC = state.port.IPC
